...
IZIN=$(curl -sS https://raw.githubusercontent.com/xyzstore/izin/main/ip | awk '{print $4}' | grep $MYIP)
if [ $MYIP = $IZIN ]; then
echo "IZIN DI TERIMA!!"
else
clear
...
wget  https://raw.githubusercontent.com/xyzstore/new7/main/limit/cybervpn.zip
unzip cybervpn.zip
cd cybervpn
rm var.txt
